...
/* Umbrella JS 2.6.5 umbrellajs.com */
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div v-show=\"show\" :class=\"{\n        'alert': true,\n        'alert-success': (type == 'success'),\n        'alert-warning': (type == 'warning'),\n        'alert-info': (type == 'info'),\n        'alert-danger': (type == 'danger')\n    }\" transition=\"fade\" role=\"alert\">\n    <button v-show=\"dismissible\" type=\"button\" class=\"close\" @click=\"show = false\">\n        <span>×</span>\n    </button>\n\n    <slot></slot>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-8f80a3ca", module.exports)
  } else {
    hotAPI.update("_v-8f80a3ca", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _FXInput = require('./FXInput.vue');

var _FXInput2 = _interopRequireDefault(_FXInput);
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<fx-input :name=\"name\" v-ref:input=\"\" :class=\"class\" :type=\"type\" :title=\"title\" :required=\"required\" :disabled=\"disabled\" :placeholder=\"placeholder\">\n</fx-input>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-555319e8", module.exports)
  } else {
    hotAPI.update("_v-555319e8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./FXInput.vue":10,"flatpickr":1,"umbrellajs":3,"vue":5,"vue-hot-reload-api":4}],9:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1683698a", module.exports)
  } else {
    hotAPI.update("_v-1683698a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"form-group\">\n    <label v-if=\"label\" class=\"control-label\">{{ label }}</label>\n    <textarea v-if=\"(type == 'textarea')\" class=\"form-control\" v-el:input=\"\" v-model=\"value\" :class=\"class\" :cols=\"cols\" :rows=\"rows\" :name=\"name\" :type=\"type\" :readonly=\"readonly\" :required=\"required\" :disabled=\"disabled\" :minlength=\"minlength\" :maxlength=\"maxlength\" :placeholder=\"placeholder\"></textarea>\n\n    <template v-else=\"\">\n        <input class=\"form-control\" v-el:input=\"\" v-model=\"value\" :class=\"class\" :name=\"name\" :type=\"type\" :title=\"title\" :readonly=\"readonly\" :required=\"required\" :disabled=\"disabled\" :minlength=\"minlength\" :maxlength=\"maxlength\" :placeholder=\"placeholder\">\n    </template>\n\n    <div v-if=\"showHelp\" class=\"help-block\">{{ help }}</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-75289589", module.exports)
  } else {
    hotAPI.update("_v-75289589", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-299dd09a", module.exports)
  } else {
    hotAPI.update("_v-299dd09a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _strings = require('../support/strings.js');
...
exports.default = {
    props: {
        ...
        show: {
            required: true,
            type: Boolean,
            coerce: _strings.coerce.boolean,
            twoWay: true
        },
    ...
    watch: {
        show: function show(val) {
            ...
            if (val) {
                ...
                setTimeout(function () {
                    return (0, _umbrellajs.u)(el).addClass('in');
                }, 0);
                (0, _umbrellajs.u)(body).addClass('modal-open');
            } else {
                el.style.display = 'none';
                body.style.paddingRight = '0';
                setTimeout(function () {
                    return (0, _umbrellajs.u)(el).removeClass('in');
                }, 0);

                (0, _umbrellajs.u)(body).removeClass('modal-open');
            }
        }
    },
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div role=\"dialog\" :class=\"{'modal': true}\">\n    <div :class=\"{'modal-dialog':true,'modal-lg':large,'modal-sm':small}\" role=\"document\">\n        <div class=\"modal-content\">\n            <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" @click=\"close\"><span>×</span></button>\n\n                <h4 class=\"modal-title\" v-if=\"title\">{{ title }}</h4>\n            </div>\n\n            <slot></slot>\n\n            <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-default\" @click=\"close\">{{ cancelText }}</button>\n                <button type=\"button\" class=\"btn btn-primary\" @click=\"callback\">{{ okText }}</button>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-de81e228", module.exports)
  } else {
    hotAPI.update("_v-de81e228", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../support/strings.js":26,"umbrellajs":3,"vue":5,"vue-hot-reload-api":4}],13:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    created: function created() {
        ...
        if (!select._select) {
            this._select = {};
            console.warn('Warning: "option" depends on "select" to work properly.');
        } else {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<li :class=\"{disabled: disabled}\">\n    <a href=\"#\" @mousedown.prevent=\"\" @mouseup.prevent=\"selectValue(value)\"><slot></slot></a>\n</li>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-31c27d46", module.exports)
  } else {
    hotAPI.update("_v-31c27d46", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
	...
	computed: {
		option: {
			get: function get() {
				return this.label != '' && this.value != '' ? { label: this.label, value: this.value } : false;
			},
		...
		checkAll: {
			get: function get() {
				return this.options.length > 0 && this.checked.length == this.options.length;
			},
			set: function set(value) {
				var checked = [];
	...
	methods: {
		...
		moveOptionUp: function moveOptionUp(index) {
			var from = index;
			var to = index - 1;

			this.options.splice(to, 0, this.options.splice(from, 1)[0]);
		},
		moveOptionDown: function moveOptionDown(index) {
			var from = index;
			var to = index + 1;
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"form\">\n\t<div class=\"row\">\n\t\t<div class=\"col-md-1\">\n\t\t\t<div v-if=\"multiple\" class=\"checkbox\">\n\t\t\t\t<label>\n\t\t\t\t\t<input type=\"checkbox\" v-model=\"checkAll\" value=\"1\">\n\t\t\t\t</label>\n\t\t\t</div>\n\t\t\t<button v-else=\"\" class=\"btn btn-default\" @click.prevent=\"clearOptions\"><i class=\"fa fa-times fa-fw\"></i></button>\n\t\t</div>\n\t\t<div class=\"col-md-4\">\n\t\t\t<div class=\"form-group\">\n\t\t\t\t<input id=\"option-builder-label\" type=\"text\" class=\"form-control\" v-model=\"label\" @keydown.enter.prevent=\"addOption\" placeholder=\"Label\">\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"col-md-4\">\n\t\t\t<div class=\"form-group\">\n\t\t\t\t<input id=\"option-builder-value\" type=\"text\" class=\"form-control\" v-model=\"value\" @keydown.enter.prevent=\"addOption\" placeholder=\"Value\">\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"col-md-3 text-right\">\n\t\t\t<button class=\"btn btn-success\" @click.prevent=\"addOption\"><i class=\"fa fa-plus fa-fw\"></i> Add</button>\n\t\t</div>\n\t</div>\n\t<div class=\"row\" v-for=\"(index, option) in options\">\n\t\t<div class=\"col-md-1\">\n\t\t\t<div class=\"checkbox\">\n\t\t\t\t<label>\n\t\t\t\t\t<input :type=\"type\" name=\"attributes[checked][{{ index }}]\" v-model=\"checked\" value=\"{{ option.value }}\">\n\t\t\t\t</label>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"col-md-4\">\n\t\t\t<div class=\"form-group\">\n\t\t\t\t<input type=\"text\" name=\"attributes[choices][{{ index }}][label]\" class=\"form-control\" value=\"{{ option.label }}\">\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"col-md-4\">\n\t\t\t<div class=\"form-group\">\n\t\t\t\t<input type=\"text\" name=\"attributes[choices][{{ index }}][value]\" class=\"form-control\" value=\"{{ option.value }}\">\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"col-md-3 text-right\">\n\t\t\t<button class=\"btn btn-primary\" @click.prevent=\"moveOptionDown(index)\" :disabled=\"index + 1 >= options.length\"><i class=\"fa fa-sort-down fa-fw\"></i></button>\n\t\t\t<button class=\"btn btn-primary\" @click.prevent=\"moveOptionUp(index)\" :disabled=\"index <= 0\"><i class=\"fa fa-sort-up fa-fw\"></i></button>\n\t\t\t<button class=\"btn btn-danger\" @click.prevent=\"removeOption(index)\"><i class=\"fa fa-trash fa-fw\"></i></button>\n\t\t</div>\n\t</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0eb30bb6", module.exports)
  } else {
    hotAPI.update("_v-0eb30bb6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
	...
	created: function created() {
		bus.$on('rows-updated', function (params) {
			this.currentPage = params.current_page;
			this.perPage = params.limit;
			this.total = params.total_count;
			this.lastPage = params.total_pages;
			this.from = params.from;
			this.to = params.to;
			this.prev = params.prev ? true : false;
			this.next = params.next ? true : false;
		}.bind(this));
	},
	...
	computed: {
		...
		minPage: function minPage() {
			return Math.max(1, this.totalPages - this.pageOffset);
		},
		maxPage: function maxPage() {
			return Math.max(this.totalPages, this.pageRange - this.pageOffset);
		},
		pageRangeLinks: function pageRangeLinks() {
			var start = this.currentPage - this.pageOffset;
			var end = this.currentPage + this.pageOffset;
			var range = [];

			start = start <= 0 ? 1 : Math.min(start, this.minPage);
			end = end >= this.totalPages ? this.totalPages : Math.max(end, this.maxPage);
		...
		queryParams: function queryParams() {
			return { page: this.currentPage, per_page: this.perPage };
		}
	},
	methods: {
		changePage: function changePage(page) {
			this.currentPage = page;
			bus.$emit('refresh-rows', this.queryParams);
		},
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"container-fluid\">\n\t<div class=\"row\">\n\t\t<div class=\"col-md-4\">\n\t\t\tShowing {{ from }} to {{ to }} of {{ total }} items.\n\t\t</div>\n\t\t<div class=\"col-md-6 col-md-offset-2 text-right\">\n\t\t\t<ul class=\"pagination pagination-sm\">\n\t\t\t\t<li class=\"{{ hasPrevPageClass }}\"><a href=\"javascript:void(0)\" @click=\"goToFirstPage()\" aria-label=\"First\"><span aria-hidden=\"true\">««</span></a></li>\n\t\t\t\t<li class=\"{{ hasPrevPageClass }}\"><a href=\"javascript:void(0)\" @click=\"goToPrevPage()\" aria-label=\"Previous\"><span aria-hidden=\"true\">«</span></a></li>\n\t\t\t\t<template v-for=\"page in pageRangeLinks\">\n\t\t\t\t\t<li class=\"{{ currentPage == page ? 'active' : '' }}\"><a href=\"javascript:void(0)\" @click=\"changePage(page)\">{{ page }}</a></li>\n\t\t\t\t</template>\n\t\t\t\t<li class=\"{{ hasNextPageClass }}\"><a href=\"javascript:void(0)\" @click=\"goToNextPage()\" aria-label=\"Next\"><span aria-hidden=\"true\">»</span></a></li>\n\t\t\t\t<li class=\"{{ hasNextPageClass }}\"><a href=\"javascript:void(0)\" @click=\"goToLastPage()\" aria-label=\"Last\"><span aria-hidden=\"true\">»»</span></a></li>\n\t\t\t</ul>\n\t\t</div>\n\t</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1cb80d6b", module.exports)
  } else {
    hotAPI.update("_v-1cb80d6b", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../support/strings.js":26,"vue":5,"vue-hot-reload-api":4}],16:[function(require,module,exports){
...
var _popover = require('../mixins/popover.js');
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<span v-el:trigger=\"\">\n    <slot></slot>\n</span>\n\n<div v-el:popover=\"\" v-show=\"show\" :class=\"['popover', placement]\" :transition=\"effect\">\n    <div class=\"arrow\"></div>\n\n    <h3 class=\"popover-title\" v-if=\"title\">\n        {{ title }}\n    </h3>\n\n    <div class=\"popover-content\">\n        <slot name=\"content\">{{{ content }}}</slot>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2beb4924", module.exports)
  } else {
    hotAPI.update("_v-2beb4924", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../mixins/popover.js":25,"vue":5,"vue-hot-reload-api":4,"vueify/lib/insert-css":6}],17:[function(require,module,exports){
"use strict";
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div v-el:select=\"\" class=\"btn-group\">\n    <select v-el:sel=\"\" v-model=\"value\" style=\"display: none; width: 1px; height: 1px; overflow: hidden;\" :name=\"name\">\n        <option v-for=\"option in options\" :value=\"option.value\"></option>\n    </select>\n\n    <div :class=\"{open: show}\">\n        <button type=\"button\" :name=\"name\" :class=\"{\n                'form-control': true,\n                'btn': true,\n                'dropdown-toggle': true,\n                'btn-default': (type == 'default'),\n                'btn-success': (type == 'success'),\n                'btn-warning': (type == 'warning'),\n                'btn-info': (type == 'info'),\n                'btn-danger': (type == 'danger')\n            }\" @click=\"toggle()\">\n            {{ selected || placeholder }} <span class=\"caret\"></span>\n        </button>\n\n        <ul class=\"dropdown-menu\">\n            <slot></slot>\n        </ul>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7d2f8e4d", module.exports)
  } else {
    hotAPI.update("_v-7d2f8e4d", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    computed: {
        active: function active() {
            return this._tablist.show == this;
        },
        index: function index() {
            return this._tablist.tabs.indexOf(this);
        },
        show: function show() {
            return this._tablist && this._tablist.show === this;
        }
    },
    ...
    created: function created() {
        ...
        while (tablist && tablist._tablist !== true && tablist.$parent) {
            tablist = tablist.$parent;
        }

        if (!tablist._tablist) {
            this._tablist = {};
            console.warn('Warning: "tab" depends on "tabs" to work properly.');
        } else {
            tablist.tabs.push(this);
            tablist.headers.push(this);

            this._tablist = tablist;
        }
    },
    beforeDestroy: function beforeDestroy() {
        if (this._tablist.active === this.index) {
            this._tablist.active = 0;
        }

        this._tablist.tabs.$remove(this);
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div role=\"tabpanel\" class=\"tab-pane active\" v-show=\"show\" :class\"{hide:=\"\" !show}\"=\"\">\n    <slot></slot>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7c2ffd94", module.exports)
  } else {
    hotAPI.update("_v-7c2ffd94", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":5,"vue-hot-reload-api":4}],19:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	computed: {
		currentSort: function currentSort() {
			return this.shared.columns[this.sortColumn]['label'];
		},
		currentSortIcon: function currentSortIcon() {
			return this.sortDirection == 'asc' ? 'sort-alpha-asc' : 'sort-alpha-desc';
		},
		currentSortQuery: function currentSortQuery() {
			return this.sortColumn + '_' + this.sortDirection;
		},
		hasPagination: function hasPagination() {
			return typeof this.$parent.$refs.tablePagination !== 'undefined';
		},
		hasSelectedRows: function hasSelectedRows() {
			return this.shared.selectedRows.length;
		},
		queryParams: function queryParams() {
			return { page: 1, filter: this.keywords, sort: this.currentSortQuery };
		}
	},
	methods: {
		showDeleteModal: function showDeleteModal() {
			vm.$set('showDeleteModal', true);
		},
		methodCallback: function methodCallback(method) {
			window[method]();
		},
		...
		toggleMultiselect: function toggleMultiselect() {
			...
			bus.$emit('multiselect', this.multiselect);
		},
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<nav class=\"navbar navbar-default\">\n\t<div class=\"container-fluid\">\n\t\t<div class=\"collapse navbar-collapse\">\n\t\t\t<ul v-if=\"shared.multiActions\" class=\"nav navbar-nav\" style=\"margin-left: -15px;\">\n\t\t\t\t<li><button class=\"btn btn-default navbar-btn\" @click=\"toggleMultiselect()\"><i class=\"fa fw fa-{{ multiselect ? 'circle-o' : 'square-o' }}\" aria-hidden=\"true\"></i></button></li>\n\t\t\t\t<li class=\"dropdown\" v-show=\"hasSelectedRows\">\n\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">Multitask <span class=\"caret\"></span></a>\n\t\t\t\t\t<ul class=\"dropdown-menu\">\n\t\t\t\t\t\t<template v-for=\"multiAction in shared.multiActions\">\n\t\t\t\t\t\t\t<li><a href=\"#\" @click=\"methodCallback(multiAction.method)\">{{ multiAction.label }}</a></li>\n\t\t\t\t\t\t</template>\n\t\t\t\t\t</ul>\n\t\t\t\t</li>\n\t\t\t</ul>\n\t\t\t<form class=\"navbar-form navbar-left\">\n\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"Search\" v-model=\"keywords\" @keydown.enter.prevent=\"filter()\">\n\t\t\t\t</div>\n\t\t\t\t<button @click.prevent=\"filter()\" type=\"button\" class=\"btn btn-primary\"><i class=\"fa fw fa-search\" aria-hidden=\"true\"></i></button>\n\t\t\t\t<button @click.prevent=\"resetFilter()\" type=\"button\" class=\"btn btn-default\">Reset</button>\n\t\t\t</form>\n\t\t\t<ul class=\"nav navbar-nav navbar-right\">\n\t\t\t\t<li class=\"dropdown\">\n\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\"><i class=\"fa fw fa-{{ currentSortIcon }}\" aria-hidden=\"true\"></i> {{ currentSort }} <span class=\"caret\"></span></a>\n\t\t\t\t\t<ul class=\"dropdown-menu\">\n\t\t\t\t\t\t<template v-for=\"(columnIndex, column) in shared.columns\">\n\t\t\t\t\t\t\t<li class=\"{{ currentSortQuery == columnIndex + '_asc' ? 'active' : '' }}\">\n\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" @click.prevent=\"sort(columnIndex, 'asc')\"><i class=\"fa fw fa-sort-alpha-asc\" aria-hidden=\"true\"></i> {{ column.label }}</a>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"{{ currentSortQuery == columnIndex + '_desc' ? 'active' : '' }}\">\n\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" @click.prevent=\"sort(columnIndex, 'desc')\"><i class=\"fa fw fa-sort-alpha-desc\" aria-hidden=\"true\"></i> {{ column.label }}</a>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t</template>\n\t\t\t\t\t</ul>\n\t\t\t\t</li>\n\t\t\t\t<li><button class=\"btn btn-default navbar-btn\" data-toggle=\"modal\" data-target=\"#tablecontrol-settings\"><i class=\"fa fw fa-cogs\" aria-hidden=\"true\"></i> Settings</button></li>\n\t\t\t</ul>\n\t\t</div>\n\t</div>\n</nav>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-aa1f3b3a", module.exports)
  } else {
    hotAPI.update("_v-aa1f3b3a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    created: function created() {
        bus.$on('refresh-rows', function (params) {
            this.refreshRows(params);
            this.shared.selectedRows = [];
        }.bind(this));

        bus.$on('multiselect', function (value) {
            this.multiSelect(value);
        }.bind(this));
    },

    methods: {
        methodCallback: function methodCallback(method, row) {
            console.log(method);
            window[method](row);
        },
        multiSelect: function multiSelect(multiselect) {
            var selections = [];

            if (multiselect) {
                this.rows.forEach(function (row) {
                    selections.push(row.slug);
                });
            }

            this.shared.selectedRows = selections;
        },
        mergeParams: function mergeParams(params) {
        ...
        refreshRows: function refreshRows(params) {
            var _this = this;

            this.mergeParams(params);
            console.log(this.shared.api + this.getQueryParams());

            this.$http.get(this.shared.api + this.getQueryParams()).then(function (response) {
                _this.rows = response.body.data;
                bus.$emit('rows-updated', response.body.paginator);
            }, function (response) {
                console.log(response);
            });
        },
        getRowValue: function getRowValue(row, index) {
            if (typeof this.shared.columns[index].callback !== 'undefined') {
                return this.shared.columns[index].callback(row);
            } else {
                return row[index];
            }
        }
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <div v-if=\"shared.layout == 'list'\" class=\"row\">\n        <table class=\"table table-striped table-bordered\">\n            <tbody><tr>\n                <th>&nbsp;</th>\n                <template v-for=\"column in shared.columns\">\n                \t<th>{{ column.label }}</th>\n                </template>\n                <th class=\"col-md-3\">&nbsp;</th>\n            </tr>\n            <tr v-for=\"(rowIndex, row) in rows\">\n    \t\t\t<td><input type=\"checkbox\" v-model=\"shared.selectedRows\" :value=\"row.slug\"></td>\n    \t\t\t<template v-for=\"(columnIndex, column) in shared.columns\">\n    \t\t\t\t<td>{{{ getRowValue(row, columnIndex) }}}</td>\n    \t        </template>\n                <td>\n                \t<template v-for=\"action in shared.actions\">\n    \t\t\t\t\t<button class=\"{{ action.class }}\" @click=\"methodCallback(action.method, row)\" style=\"margin-left: 5px;\">\n    \t\t\t\t\t\t<i class=\"{{ action.icon }}\" aria-hidden=\"true\"></i> {{ action.label }}\n    \t\t\t\t\t</button>\n                \t</template>\n                </td>\n            </tr>\n        </tbody></table>\n    </div>\n\n    <div v-if=\"shared.layout == 'tiled'\" class=\"row\">\n        <div class=\"col-md-4\" v-for=\"(rowIndex, row) in rows\">\n            <template v-for=\"(columnIndex, column) in shared.columns\">\n                {{{ getRowValue(row, columnIndex) }}}<br>\n            </template>\n            <input type=\"checkbox\" v-model=\"shared.selectedRows\" :value=\"row.slug\">\n            <template v-for=\"action in shared.actions\">\n                <button class=\"{{ action.class }}\" @click=\"methodCallback(action.method, row)\" style=\"margin-left: 5px;\">\n                    <i class=\"{{ action.icon }}\" aria-hidden=\"true\"></i> {{ action.label }}\n                </button>\n            </template>\n            <hr>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7a87a686", module.exports)
  } else {
    hotAPI.update("_v-7a87a686", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
	...
	computed: {
		selectedViewIsList: function selectedViewIsList() {
			return this.shared.layout == 'list' ? 'primary' : 'default';
		},
		selectedViewIsTiled: function selectedViewIsTiled() {
			return this.shared.layout == 'tiled' ? 'primary' : 'default';
		}
	}
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<nav class=\"navbar navbar-default text-center\">\n\t<button class=\"btn btn-{{ selectedViewIsList }} navbar-btn\" @click=\"shared.layout = 'list'\" style=\"margin-right: 10px;\"><i class=\"fa fa-fw fa-list\" aria-hidden=\"true\"></i> List</button>\n\t<button class=\"btn btn-{{ selectedViewIsTiled }} navbar-btn\" @click=\"shared.layout = 'tiled'\"><i class=\"fa fa-fw fa-th-large\" aria-hidden=\"true\"></i> Tiled</button>\n</nav>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0a86b211", module.exports)
  } else {
    hotAPI.update("_v-0a86b211", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <ul class=\"nav nav-tabs\" role=\"tablist\">\n        <template v-for=\"t in headers\">\n            <li :class=\"{active:t.active, disabled:t.disabled}\" @click.prevent=\"select(t)\">\n                <a href=\"#\"><slot name=\"header\">{{{ t.header }}}</slot></a>\n            </li>\n        </template>\n    </ul>\n\n    <div class=\"tab-content\" v-el:tab-content=\"\">\n        <slot></slot>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-38675132", module.exports)
  } else {
    hotAPI.update("_v-38675132", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<span v-el:trigger=\"\">\n    <slot></slot>\n</span>\n\n<div v-el:popover=\"\" v-show=\"show\" role=\"tooltip\" :class=\"['tooltip', placement]\" :transition=\"effect\">\n    <div class=\"tooltip-arrow\"></div>\n    <div class=\"tooltip-inner\">\n        <slot name=\"content\">{{{ content }}}</slot>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5080db82", module.exports)
  } else {
    hotAPI.update("_v-5080db82", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../mixins/popover.js":25,"vue":5,"vue-hot-reload-api":4,"vueify/lib/insert-css":6}],24:[function(require,module,exports){
'use strict';

var _FXAlert = require('./components/FXAlert.vue');

var _FXAlert2 = _interopRequireDefault(_FXAlert);

var _FXDatetime = require('./components/FXDatetime.vue');

var _FXDatetime2 = _interopRequireDefault(_FXDatetime);

var _FXIcon = require('./components/FXIcon.vue');

var _FXIcon2 = _interopRequireDefault(_FXIcon);

var _FXInput = require('./components/FXInput.vue');

var _FXInput2 = _interopRequireDefault(_FXInput);

var _FXLabel = require('./components/FXLabel.vue');

var _FXLabel2 = _interopRequireDefault(_FXLabel);

var _FXModal = require('./components/FXModal.vue');

var _FXModal2 = _interopRequireDefault(_FXModal);

var _FXOption = require('./components/FXOption.vue');

var _FXOption2 = _interopRequireDefault(_FXOption);

var _FXOptionBuilder = require('./components/FXOptionBuilder.vue');

var _FXOptionBuilder2 = _interopRequireDefault(_FXOptionBuilder);

var _FXPagination = require('./components/FXPagination.vue');

var _FXPagination2 = _interopRequireDefault(_FXPagination);

var _FXPopover = require('./components/FXPopover.vue');

var _FXPopover2 = _interopRequireDefault(_FXPopover);

var _FXSelect = require('./components/FXSelect.vue');

var _FXSelect2 = _interopRequireDefault(_FXSelect);

var _FXTab = require('./components/FXTab.vue');

var _FXTab2 = _interopRequireDefault(_FXTab);

var _FXTableControls = require('./components/FXTableControls.vue');

var _FXTableControls2 = _interopRequireDefault(_FXTableControls);

var _FXTableRows = require('./components/FXTableRows.vue');

var _FXTableRows2 = _interopRequireDefault(_FXTableRows);

var _FXTableViews = require('./components/FXTableViews.vue');

var _FXTableViews2 = _interopRequireDefault(_FXTableViews);

var _FXTablist = require('./components/FXTablist.vue');

var _FXTablist2 = _interopRequireDefault(_FXTablist);

var _FXTooltip = require('./components/FXTooltip.vue');

var _FXTooltip2 = _interopRequireDefault(_FXTooltip);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var FXKit = {
    FXAlert: _FXAlert2.default,
    FXDatetime: _FXDatetime2.default,
    FXIcon: _FXIcon2.default,
    FXInput: _FXInput2.default,
    FXLabel: _FXLabel2.default,
    FXModal: _FXModal2.default,
    FXOption: _FXOption2.default,
    FXOptionBuilder: _FXOptionBuilder2.default,
    FXPagination: _FXPagination2.default,
    FXPopover: _FXPopover2.default,
    FXSelect: _FXSelect2.default,
    FXTab: _FXTab2.default,
    FXTableControls: _FXTableControls2.default,
    FXTableRows: _FXTableRows2.default,
    FXTableViews: _FXTableViews2.default,
    FXTablist: _FXTablist2.default,
    FXTooltip: _FXTooltip2.default,

    install: function install(Vue) {
        Vue.component('fx-alert', _FXAlert2.default);
        Vue.component('fx-datetime', _FXDatetime2.default);
        Vue.component('fx-icon', _FXIcon2.default);
        Vue.component('fx-input', _FXInput2.default);
        Vue.component('fx-label', _FXLabel2.default);
        Vue.component('fx-modal', _FXModal2.default);
        Vue.component('fx-option', _FXOption2.default);
        Vue.component('fx-option-builder', _FXOptionBuilder2.default);
        Vue.component('fx-pagination', _FXPagination2.default);
        Vue.component('fx-popover', _FXPopover2.default);
        Vue.component('fx-select', _FXSelect2.default);
        Vue.component('fx-tab', _FXTab2.default);
        Vue.component('fx-table-controls', _FXTableControls2.default);
        Vue.component('fx-table-rows', _FXTableRows2.default);
        Vue.component('fx-table-views', _FXTableViews2.default);
        Vue.component('fx-tabs', _FXTablist2.default);
        Vue.component('fx-tooltip', _FXTooltip2.default);
    }
};
...
},{"./components/FXAlert.vue":7,"./components/FXDatetime.vue":8,"./components/FXIcon.vue":9,"./components/FXInput.vue":10,"./components/FXLabel.vue":11,"./components/FXModal.vue":12,"./components/FXOption.vue":13,"./components/FXOptionBuilder.vue":14,"./components/FXPagination.vue":15,"./components/FXPopover.vue":16,"./components/FXSelect.vue":17,"./components/FXTab.vue":18,"./components/FXTableControls.vue":19,"./components/FXTableRows.vue":20,"./components/FXTableViews.vue":21,"./components/FXTablist.vue":22,"./components/FXTooltip.vue":23}],25:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    ready: function ready() {
        ...
        if (!popover) return console.error('Could not find popover v-el in your component using the popover mixin.');
        ...
        if (this.trigger === 'focus' && !~trigger.tabIndex) {
            trigger = (0, _umbrellajs.u)('a,input,select,textarea,button', trigger);

            if (!trigger.length) {
                trigger = null;
            }{
                (0, _umbrellajs.u)(trigger).on(events, this.toggle);
    ...
    beforeDestroy: function beforeDestroy() {
        (0, _umbrellajs.u)(this.$els.trigger.chilren[0]).off();
    }
};

},{"umbrellajs":3}],26:[function(require,module,exports){
'use strict';
...
var coerce = exports.coerce = {
    ...
    number: function number(val) {
        ...
        return typeof val === 'number' ? val : val === 'undefined' || val === null || isNaN(Number(val)) ? alt : Number(alt);
    }
};

},{}]},{},[24]);

//# sourceMappingURL=fx-kit.js.map
